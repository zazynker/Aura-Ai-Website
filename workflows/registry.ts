...
> = {
  ...
  'image.modify': {
    ...
    inputs: [
      ...
      {
        key: 'reference_image',
        label: 'Subject reference 1',
        description: 'Primary identity or content reference to apply to the Source image. This is normally user-replaceable.',
        assetType: 'image',
        required: false,
        maxCount: 1,
        acceptedMimeTypes: IMAGE_MIME_TYPES,
      ...
      },
      {
        ...
        label: 'Subject reference 2',
        description: 'Optional second identity or content reference. GPT Image 2 Edit supports two subject references alongside the Source image.',
        assetType: 'image',
        required: false,
        maxCount: 1,
        acceptedMimeTypes: IMAGE_MIME_TYPES,
  ...
  'audio.text_to_speech': {
    key: 'audio.text_to_speech',
    version: 1,
    displayName: 'Text to Speech',
    description: 'Generate a standalone voice track with MiniMax Speech 2.5 HD.',
    // The standalone audio editor does not exist yet. Quick Use executes this
    // capability directly; this target only preserves the registry contract.
    editorTarget: {
      route: '/video',
      editor: 'video',
      featureKey: 'text-to-speech',
    },
    inputs: [],
    parameters: [
      {
      ...
      },
      {
        ...
        enumValues: ['happy', 'sad', 'angry', 'fearful', 'disgusted', 'surprised', 'neutral'],
      },
      {
        key: 'languageBoost',
        label: 'Language',
        ...
        editable: true,
        defaultValue: 'auto',
        enumValues: ['auto', 'Chinese', 'English', 'Japanese', 'Korean', 'French', 'German', 'Spanish', 'Portuguese', 'Russian', 'Italian'],
      },
      {
        key: 'format',
        label: 'Format',
