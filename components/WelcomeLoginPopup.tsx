...
export const WelcomeLoginPopup: React.FC<WelcomeLoginPopupProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex w-full max-w-sm origin-center scale-[0.64] flex-col overflow-hidden rounded-2xl bg-white shadow-2xl animate-in zoom-in-95 duration-200 sm:scale-[0.82] lg:scale-100">
        <button
          type="button"
          onClick={onClose}
